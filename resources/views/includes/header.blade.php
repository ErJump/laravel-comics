        ...
        <div class="container-lg d-flex ">
            ...
            <div class=" justify-content-end" id="navbarNavAltMarkup">
                <div class="navbar-nav justify-self-end">
                    ...
                    <a class="nav-link active px-3" href="#">Games</a>
                    <a class="nav-link active px-3" href="#">Collectibles</a>
                    <a class="nav-link active px-3" href="#">Videos</a>
                    <a class="nav-link active px-3" href="#">Fans</a>
                    <a class="nav-link active px-3" href="#">News</a>
                    <a class="nav-link active px-3" href="#">Shop</a>    
                </div>
            </div>
        </div>
    </nav>
